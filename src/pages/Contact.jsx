                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-4 pb-6 border-b border-white border-opacity-20">
                    ...
                    <div>
                      ...
                      <p className="opacity-90 text-lg">neighborhoodbuilder@gmail.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 pb-6 border-b border-white border-opacity-20">
                    ...
                    <div>
                      ...
                      <p className="opacity-90 text-lg">+44 7123 456789</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 pb-6 border-b border-white border-opacity-20">
                    ...
                    <div>
                      ...
                      <p className="opacity-90 text-lg">London, United Kingdom</p>
                    </div>
                  </div>
